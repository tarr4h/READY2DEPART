package com.web.trv.comn.config;
...
@MapperScan(value = "com.web.trv", sqlSessionFactoryRef = "SqlSessionFactory")
public class MybatisConfig {
    ...
    public SqlSessionFactory SqlSessionFactory(@Qualifier("dataSource") DataSource dataSource, ApplicationContext applicationContext) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.trv.**.model,com.web.trv.**.model,com.trv.**.entity,com.web.trv.**.entity");
